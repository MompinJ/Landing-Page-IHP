...
function Row({ r, i }) {
  ...
  return (
    <div className="r" style={{
      ...
      <span style={{ color: 'rgba(0,46,109,0.16)', fontWeight: 800, fontSize: 44, lineHeight: 1 }}>
        {r.num}
      </span>

      <div>
        <div style={{ color: SEA, fontWeight: 800, fontSize: 26, letterSpacing: '-0.5px' }}>
          {r.module}
        </div>
    ...
    <div style={{
      ...
      <div style={{ position: 'absolute', left: 112, top: 92, zIndex: 5, width: 1696 }}>
        <div className="r" style={{ '--d': 60 }}>
          <Eyebrow color={AQUAD} size={22}>Cierre · Cumplimiento de objetivos</Eyebrow>
        </div>
